...
public class Tests2025
{
    ...
    [Fact]
    public static async Task Test_DaySeven()
    {
        // Arrange
        var expected = 21;

        // Act
        var actual = await Answers2025.DaySeven("DaySevenTest.txt");
    ...
    [Fact]
    public static async Task Test_DayNine()
    {
        // Arrange
        var expected = 50;

        // Act
        var actual = await Answers2025.DayNine("DayNineTest.txt");
